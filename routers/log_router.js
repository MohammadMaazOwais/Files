...
logRouter.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var resp, resp_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
                return [4 /*yield*/, logs_1["default"].findOne({
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, logs_1["default"].create(req.body)];
            case 3:
                resp_1 = _a.sent();
